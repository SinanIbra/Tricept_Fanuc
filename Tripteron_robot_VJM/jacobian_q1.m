function J = jacobian_q1(angles,passive_deflection,bases ,flag)
...
if flag =='x'
    base = bases.x;
    T01 = base* Tx(t(1)) *Rdx(-q1) * Tx(0) * Ty(1) ;
...
elseif flag =='y'
    base = bases.y;
    T01 = base* Ty(t(1))* Rdy(-q1) * Ty(0) * Tz(1);
    T_sp1 = Rx(t(2))* Ry(t(3)) * Rz(t(4)) * Tx(t(5)) * Ty(t(6)) * Tz(t(7));
    T12 = Ry(-q2) * Ty(0) * Tz(1);
    T_sp2 = Rx(t(8))* Ry(t(9)) * Rz(t(10)) * Tx(t(11)) * Ty(t(12)) * Tz(t(13));
    T23 = Ry(q3);
...
elseif flag == 'z' 
    base = bases.z;
    T01 = base*Tz(t(1))* Rdz(-q1) * Tz(0) * Ty(1);
    T_sp1 = Rx(t(2))* Ry(t(3)) * Rz(t(4)) * Tx(t(5)) * Ty(t(6)) * Tz(t(7));
    T12 = Rz(-q2) * Ty(0) * Ty(1);
    T_sp2 = Rx(t(8))* Ry(t(9)) * Rz(t(10)) * Tx(t(11)) * Ty(t(12)) * Tz(t(13));
    T23 = Rz(q3);
